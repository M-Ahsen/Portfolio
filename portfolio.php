...
<body data-spy="scroll" data-target=".site-navbar-target" data-offset="300">
	...
	<nav class="navbar navbar-expand-lg navbar-dark ftco_navbar ftco-navbar-light site-navbar-target" id="ftco-navbar">
		<div class="container">
		<a class="navbar-brand" href="<?= htmlspecialchars($_SERVER['PHP_SELF']); ?>">
    <?= htmlspecialchars($homeData['full_name'] ?? 'Your Name') ?>
			</a>
    ...
    playTypingAnimation();
								...
								<!-- <br> -->
								<p><a href="<?= htmlspecialchars($homeData['linkedin'] ?? '#') ?>" target="_blank"
										class="btn btn-primary py-3 px-4">LinkedIn</a>
                                        <?php if (!empty($homeData['resumePath'])): ?>
                                            <a href="<?= htmlspecialchars($homeData['resumePath']) ?>"
