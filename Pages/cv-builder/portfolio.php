    ...
    <body>
        ...
        <section id="about-section" class="about-section">
            ...
            <?php if (!empty($aboutData['about_photo_path'])): ?>
                <img src="../uploads/<?= htmlspecialchars($aboutData['about_photo_path']) ?>" alt="profile-picture" width="20%"
        ...
        <section id="portfolio-section" class="portfolio-section">
            ...
            <?php while ($project = $resultProjects->fetch_assoc()): ?>
                ...
                <div class="project">
                    ...
                    <a href="project.php?user_id=<?php echo $user_id ?>" target="_blank">
        ...
        <section id="contact-section" class="contact-section">
            ...
            <div class="contact-details">
                ...
                <p><a
                        href="tel:<?= htmlspecialchars($contactData['contact_phone'] ?? '#') ?>"><?= htmlspecialchars($contactData['contact_phone'] ?? 'Not provided') ?></a>
                </p>

                <h3>Email Address</h3>
                <p><a
                        href="mailto:<?= htmlspecialchars($contactData['contact_email'] ?? '#') ?>"><?= htmlspecialchars($contactData['contact_email'] ?? 'Not provided') ?></a>
                </p>
            </div>
        </section>
